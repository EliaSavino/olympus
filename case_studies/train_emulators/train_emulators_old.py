...
for dataset_name in dataset_names:
    ...
    emulator_model = pickle.load(
        open(
            f"{__home__}/emulators/emulator_{current_dataset}_BayesNeuralNet/emulator.pickle",
            "rb",
        )
    )
    ...
    best_scores[current_dataset] = {"scores": scores, "old_scores": old_model_scores}
